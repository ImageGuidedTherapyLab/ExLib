 ...
 *
 *=========================================================================*/
#ifndef itkNeighborhoodConnectedSubsetImageFilter_h
#define itkNeighborhoodConnectedSubsetImageFilter_h

#include "itkImageToImageFilter.h"

namespace itk
{
/** \class NeighborhoodConnectedSubsetImageFilter
 * \brief Label pixels that are connected to a seed and lie within a neighborhood
 *
 * NeighborhoodConnectedSubsetImageFilter labels pixels with ReplaceValue that
...
class ITK_TEMPLATE_EXPORT NeighborhoodConnectedSubsetImageFilter : public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(NeighborhoodConnectedSubsetImageFilter);

  /** Standard class type aliases. */
  using Self = NeighborhoodConnectedSubsetImageFilter;
  ...
  itkTypeMacro(NeighborhoodConnectedSubsetImageFilter, ImageToImageFilter);
...
protected:
  NeighborhoodConnectedSubsetImageFilter();
  ~NeighborhoodConnectedSubsetImageFilter() override = default;

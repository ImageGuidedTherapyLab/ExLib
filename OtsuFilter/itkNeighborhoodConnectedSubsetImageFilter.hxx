 ...
 *
 *=========================================================================*/
#ifndef itkNeighborhoodConnectedSubsetImageFilter_hxx
#define itkNeighborhoodConnectedSubsetImageFilter_hxx
...
NeighborhoodConnectedSubsetImageFilter<TInputImage,
TOutputImage>::NeighborhoodConnectedSubsetImageFilter()
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::ClearSeeds()
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::SetSeed(const IndexType & seed)
{
  this->ClearSeeds();
  this->AddSeed(seed);
}
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::AddSeed(const IndexType & seed)
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::GenerateInputRequestedRegion()
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::EnlargeOutputRequestedRegion(DataObject * output)
{
...
template <typename TInputImage, typename TOutputImage>
void
NeighborhoodConnectedSubsetImageFilter<TInputImage, TOutputImage>::GenerateData()
{
  ...
  using FunctionType = NeighborhoodSubsetThresholdImageFunction<InputImageType>;

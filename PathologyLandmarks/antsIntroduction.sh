...
cp ${FIXED}  ${tmpdir}/fixed`basename ${FIXED}`
cp ${MOVING} ${tmpdir}/moving`basename ${MOVING}`
cd ${tmpdir}/

FIXED=fixed`basename ${FIXED}`
MOVING=moving`basename ${MOVING}`

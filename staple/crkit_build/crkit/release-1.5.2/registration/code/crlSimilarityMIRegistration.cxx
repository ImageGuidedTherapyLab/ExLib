...
int main( int argc, char *argv[] )
{
  ...
  optimizerScales[5] = translationScale;
    ...
    ( (transform->GetNumberOfParameters() == 10) ||
      (transform->GetNumberOfParameters() == 15) ) {
    // 10: similarity 3d transform
    // 15: full affine transform
  ...
  if (transform->GetNumberOfParameters() >= 6)
    {
    optimizerScales[3] = optimizerScales[4] = optimizerScales[5] = translationScale;
    }
#endif

...
int main( int argc, char *argv[] )
{
  ...
  try
    {
      ...
      TCLAP::ValueArg<std::string> metricNameArg("","metricName","Name of metric",false,"","name of metric (string: one of mi, normmi, meansquares, normcorr)",cmd);
  ...
  if (!strcmp(
    ...
    metricBase->GetNameOfClass(),"MeanSquaresImageToImageMetric")
      ...
      ; // No special initialization of MeanSquares metric
  } else if (!strcmp(
...
*/
  ...
  // Create the registration observer and register it with the optimizer.
  //

...
*/
#ifndef __itkNLOPTOptimizers_h
#define __itkNLOPTOptimizers_h

#include <itkVector.h>
#include <itkMatrix.h>
#include <itkSingleValuedNonLinearOptimizer.h>

#include "nlopt-2.2/api/nlopt.h"
...
namespace itk
{
	 ...
	 * \date	July 2010
	*************************************************************************************************/
	class ITK_EXPORT NLOPTOptimizers: 
	...
	public:
		...
		typedef SmartPointer<Self>             Pointer;			/**< Standard ITK "Pointer" typedef. */
		typedef SmartPointer<const Self>       ConstPointer;	/**< Standard ITK "ConstPointer" typedef. */
		...
		*************************************************************************************************/
		...
		/** After the optimization, provides the time the optimization has
		  * taken
		  */
		itkSetMacro( TimeForOptimization, double );
		itkGetConstReferenceMacro( TimeForOptimization, double );
...
//		itkSetMacro(CatchGetValueException, bool);
		...
		void AddInequalityConstraint(nlopt_func fct, double tol);
		void ClearInequalityConstraints();
		void AddEqualityConstraint(nlopt_func fct, double tol);
	...
	private:
		...
		std::vector<ConstraintType> m_InequalityConstaint;
		std::vector<ConstraintType> m_EqualityConstaint;

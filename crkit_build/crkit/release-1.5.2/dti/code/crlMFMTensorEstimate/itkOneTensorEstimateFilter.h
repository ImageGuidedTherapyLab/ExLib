...
#ifndef __itkOneTensorEstimateFilter_h
#define __itkOneTensorEstimateFilter_h
...
class ITK_EXPORT OneTensorEstimateFilter :
...
public:
  ...
  typedef OneTensorEstimateFilter  Self;
  ...
  itkTypeMacro(OneTensorEstimateFilter, 
                                                      ImageToImageFilter);
...
#include "itkOneTensorEstimateFilter.txx"
#endif

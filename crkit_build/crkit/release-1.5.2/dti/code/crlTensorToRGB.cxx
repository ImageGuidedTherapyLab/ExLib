...
// Compute an RGB image representing a color encoded diffusion tensor image.

int main(int argc, const char *argv[])
{

  if (argc != 3) {
    std::cerr << "Usage: " << argv[0] << " tensorImage rgbImage" << std::endl;
    exit(1);
  }
  ...
  crl::TensorToRGBBase::Pointer tsm;
  ...
  if (imageIO->GetComponentType() == itk::ImageIOBase::DOUBLE) {
   ...
   tsm = crl::TensorToRGB<ImageDimension, double>::New();
   ...
   tsm = crl::TensorToRGB<ImageDimension, float>::New();
  } else {
